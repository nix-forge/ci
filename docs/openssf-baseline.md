...
version 2026.08.28 as its security policy reference. The policy covers shared
workflows, composite actions,
queue reconciliation, release automation, and repository tests.

## Current assessed status

The [current self-assessment](https://www.bestpractices.dev/en/projects/14642/baseline-2)
